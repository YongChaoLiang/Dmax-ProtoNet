...
def main():
    parser = argparse.ArgumentParser(
        description="KNN regression for Dmax prediction and test-set R2/RMSE/MAE (evaluation only)."
    )
    ...
    parser.add_argument("--metric", type=str, default="minkowski",
                        help="Distance metric (default: minkowski; p=2 gives Euclidean).")
    parser.add_argument("--p", type=int, default=2,
                        help="Power parameter for Minkowski metric (default: 2 for Euclidean).")
    ...
    print(f"[KNN] k={args.k} weights={args.weights} metric={args.metric} p={args.p}")
